...
app.client.request = function(headers,path,method,querStringObject,payload,callback){

	// Set defaults
	headers = typeof(headers) == 'object' && headers !== null ? headers : {};
	path = typeof(path) == 'string' ? path : '';
	method = typeof(method) == 'string' && ['POST','GET','PUT','DELETE'].indexOf(method.toUpperCase()) > -1 ? method.toUpperCase() : 'GET';
	queryStringObject = typeof(querStringObject) == 'object' && querStringObject !== null ? querStringObject : {};
	...
	for(var queryKey in queryStringObject){
		if(queryStringObject.hasOwnProperty(queryKey)){
			...
			requestUrl+=queryKey+'='+querStringObject[queryKey];
		}
	}
...
app.formResponseProcessor = function(formId,requestPayload,responsePayload){
  ...
  // If account creation was a success, try to immediately log the user in
